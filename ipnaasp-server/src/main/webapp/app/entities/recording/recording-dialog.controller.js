(function() {
    ...
    RecordingDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Recording', 'User', 'Policy'];

    function RecordingDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Recording, User, Policy) {
        var vm = this;
