...
export class AuthService {
    ...
    authorize (force) {
        ...
        function authThen () {
            ...
            if (isAuthenticated && this.$rootScope.toState.parent === 'account' && (this.$rootScope.toState.name === 'login' || this.$rootScope.toState.name === 'register' || this.$rootScope.toState.name === 'social-auth')) {
                this.$state.go('home');
            }
